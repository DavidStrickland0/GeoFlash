...
{
    public class MultipleChoiceCapitol : ContentPage, ICloseablePage
    {

        IVibrator vibrator;
        public MultipleChoiceCapitol(IFlashCardData flashCardData)
        {
           this.BindingContext = new MultipleChoiceCapitolViewModel();
           vibrator = DependencyService.Get<IVibrator>();
            ...
            myContentGrid.SetBinding<MultipleChoiceCapitolViewModel>(Grid.BackgroundColorProperty, (vm) => vm.BackGroundColor);
            Assembly flashCardAssembly = flashCardData.GetType().GetTypeInfo().Assembly;
            var imagePicture = new Image();
            ImageSource imageSource = ImageSource.FromResource(string.Format("{0}{1}", "GeoFlash.", ((MultipleChoiceCapitolViewModel)this.BindingContext).ImagePath), flashCardAssembly);
            ...
            ((INotifyPropertyChanged)this.BindingContext).PropertyChanged += (s, e) =>
            {
                ...
                {
                    string resourceName = string.Format("{0}{1}", "GeoFlash.", ((MultipleChoiceCapitolViewModel)this.BindingContext).ImagePath);
                    imagePicture.Source = ImageSource.FromResource(resourceName, flashCardAssembly);
                }
            };

            var imageLabel = new Label();
            imageLabel.SetBinding<GeoFlashViewModel>(Label.TextProperty, (vm) => vm.ImageTitle);
            imageLabel.FontSize = Device.GetNamedSize(NamedSize.Large, typeof(Label))*2;
            imageLabel.FontAttributes = FontAttributes.Bold;
            imageLabel.HorizontalOptions = LayoutOptions.CenterAndExpand;
			...
			firstAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.TextProperty,(vm) => vm.FirstAnswer);
            firstAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.IsVisibleProperty, (vm) => vm.FirstAnswerVisible);
            firstAnswerButton.Clicked += (s, e) =>
            {
                ((MultipleChoiceCapitolViewModel)this.BindingContext).AnswerSelected(1);
            };
            ...
            secondAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.TextProperty, (vm) => vm.SecondAnswer);
            secondAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.IsVisibleProperty, (vm) => vm.SecondAnswerVisible);
            secondAnswerButton.Clicked += (s, e) =>
            {
                ((MultipleChoiceCapitolViewModel)this.BindingContext).AnswerSelected(2);
            };
            ...
            thirdAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.TextProperty, (vm) => vm.ThirdAnswer);
            thirdAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.IsVisibleProperty, (vm) => vm.ThirdAnswerVisible);
            thirdAnswerButton.Clicked += (s, e) =>
            {
                ((MultipleChoiceCapitolViewModel)this.BindingContext).AnswerSelected(3);
            };
            ...
            forthAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.TextProperty, (vm) => vm.NoneString);
            forthAnswerButton.SetBinding<MultipleChoiceCapitolViewModel>(Button.IsVisibleProperty, (vm) => vm.ForthAnswerVisible);
            forthAnswerButton.Clicked += (s, e) =>
            {
                ((MultipleChoiceCapitolViewModel)this.BindingContext).AnswerSelected(4);
            };
            ...
            pointsDisplayValue.SetBinding<MultipleChoiceCapitolViewModel>(Label.TextProperty, (vm) => vm.Points, BindingMode.OneWay, new ToStringConvertor());
            ...
            Grid.SetRowSpan(imagePicture,2); 

            myContentGrid.Children.Add(pointsStackLayout, 0, 0);

            myContentGrid.Children.Add(imageLabel, 0, 1);
            Grid.SetColumnSpan(imageLabel, 2);

            myContentGrid.Children.Add(firstAnswerButton, 0, 2);
            myContentGrid.Children.Add(secondAnswerButton, 0, 3);
            myContentGrid.Children.Add(thirdAnswerButton, 1, 2);
            myContentGrid.Children.Add(forthAnswerButton, 1, 3);
            ...
            ((MultipleChoiceCapitolViewModel)this.BindingContext).RequestClose += (s, e) => { OnRequestClose(); };
            ((MultipleChoiceCapitolViewModel)this.BindingContext).DisplayScore += (s, e) => { DisplayAlert(AppResources._Complete, e.ToString(), AppResources._Ok); };

        }

        protected override bool OnBackButtonPressed()
        {
            if (!((MultipleChoiceCapitolViewModel)this.BindingContext).EndOfList && ((MultipleChoiceCapitolViewModel)this.BindingContext).Points>0)
            {
